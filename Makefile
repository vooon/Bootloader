...
#
TARGETS			 = px4fmu_bl px4fmuv2_bl px4flow_bl stm32f4discovery_bl px4io_bl captainpro2_bl
...
px4fmu_bl: $(MAKEFILE_LIST)
	make -f Makefile.f4 TARGET=fmu INTERFACE=USB BOARD=FMU USBDEVICESTRING="\\\"PX4 BL FMU v1.x\\\"" USBPRODUCTID="0x0001"

px4fmuv2_bl: $(MAKEFILE_LIST)
	make -f Makefile.f4 TARGET=fmuv2 INTERFACE=USB BOARD=FMUV2 USBDEVICESTRING="\\\"PX4 BL FMU v2.x\\\"" USBPRODUCTID="0x0001"
...
captainpro2_bl: $(MAKEFILE_LIST)
	make -f Makefile.f4 TARGET=captainpro2 INTERFACE=USB BOARD=CAPTAINPRO2 USBDEVICESTRING="\\\"PX4 BL CAPTAIN PRO2\\\"" USBPRODUCTID="0x0001"
